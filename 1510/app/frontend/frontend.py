...
# port = 5000
backend_default_url = "http://backend:80"
backend_url = os.getenv("BACKEND_URL", backend_default_url)
...
def index():
    ...
    return f'<html style="background:orange;">Hello World V2, IP: {ips}, Backend Response: {backend_response} </html>'
